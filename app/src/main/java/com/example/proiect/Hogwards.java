...
public class Hogwards extends AppCompatActivity {
    ...
    private String link1="https://www.hogwartslegacy.com/en-us/faq";
    private String link2="https://www.wizardingworld.com/hogwarts-legacy";
            ...
            public void onClick(View v) {
                if(!answered){
                    if(button1.isChecked() || button2.isChecked() || button3.isChecked()){
                        ...
                        Toast.makeText(Hogwards.this, "Select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNestQuestion();;
                }
    ...
    private void finishQuiz(){
        Intent intent = new Intent(Hogwards.this, Finish.class);
        intent.putExtra("score", score);
        intent.putExtra("quizName", "Hogwarts");
