...
public class GTA extends AppCompatActivity {
    ...
    private String link1="https://gta.fandom.com/wiki/Grand_Theft_Auto_V";
    private String link2="https://triviawhizz.com/trivia-questions/grand-theft-auto";
            ...
            public void onClick(View v) {
                if(!answered){
                    if(button1.isChecked() || button2.isChecked() || button3.isChecked()){
                        ...
                        Toast.makeText(GTA.this, "Select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNestQuestion();
                }
    ...
    private void finishQuiz(){
        Intent intent = new Intent(GTA.this, Finish.class);
        intent.putExtra("score", score);
        intent.putExtra("quizName", "GTA V");
